package com.xinput.thinking.in.spring.i18n;
...
/**
 * Spring Boot 场景下自定义 {@link MessageSource}
 *
 * @see MessageSource
...
public class CustomizedMessageSourceBeanDemo { // @Configuration class
  ...
  /**
   * 在 Spring boot 场景中，Primary Configuration Source(class) 高于 *AutoConfiguration
   */
